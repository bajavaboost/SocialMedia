...
public class JwtFilter extends OncePerRequestFilter {
    ...
    //Autowired --> spring ayağa kalktığında ilgili sınıftan oluşturulan bir bean varsa bunu arka tarafta yakalayıp burada kullanmamızı sağlar.
    @Autowired
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authorizationHeader!=null && authorizationHeader.startsWith("Bearer ")){
            ...
            if (id.isPresent()){
                ...
                //Bu ayrıntılar, kullanıının kimlik bilgilerini, rollerini ve yetkilerinden oluşmaktadır.
                //Bu ayrıntıları JwtUserDetails adındaki bir sınıfın içerisindeki loadUserByUserId metodundan alacağız.
